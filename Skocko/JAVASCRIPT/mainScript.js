...
var Muzika = true;
var Zvuk = true;
var PocelaMuzika = false;
var manjaDimenzijaEkrana = 0;
...
function organizeScreen() {
    manjaDimenzijaEkrana = Math.min(window.innerWidth, window.innerHeight);
    ...
    borderSizeByClaee("tacka", 0.1);
    borderSizeByClaee("inputImages", 0.1);
    this.scaleMarginById("back", 1.4, 0, 0, 0);
    this.scaleMarginById("kontrolnaTabla", 1.4, 0, 0, 0);
    this.scaleMarginById("tabla", 4.5, 0, 1, 0);
    scalePaddingByClass("polje", 0, 0, 0.1, 0.1);
    scaleBoxShadowByClass("polje", 0.1, 0.2, 0, "black");
    //scaleBoxShadowByClass("inputImages", 0, 0.9, 0.9, "black");
}

function scaleById(element, width, height) {
    document.getElementById(element).style.width = String(manjaDimenzijaEkrana * (width / 100)) + "px";
    document.getElementById(element).style.height = String(manjaDimenzijaEkrana * (height / 100)) + "px";
}

function scaleByClass(elements, width, height) {
    var elementsArray = document.getElementsByClassName(elements);
    for (var i = 0; i < elementsArray.length; i++) {
        elementsArray[i].style.width = String(manjaDimenzijaEkrana * (width / 100)) + "px";
        elementsArray[i].style.height = String(manjaDimenzijaEkrana * (height / 100)) + "px";
    }
}

function scaleMarginById(element, top, bootom, left, right) {
    document.getElementById(element).style.marginTop = String(manjaDimenzijaEkrana * (top / 100)) + "px";
    document.getElementById(element).style.marginBottom = String(manjaDimenzijaEkrana * (bootom / 100)) + "px";
    document.getElementById(element).style.marginLeft = String(manjaDimenzijaEkrana * (left / 100)) + "px";
    document.getElementById(element).style.marginRight = String(manjaDimenzijaEkrana * (right / 100)) + "px";
}

function scaleMarginByClass(elements, top, bootom, left, right) {
    var elementsArray = document.getElementsByClassName(elements);
    for (var i = 0; i < elementsArray.length; i++) {
        elementsArray[i].style.marginTop = String(manjaDimenzijaEkrana * (top / 100)) + "px";
        elementsArray[i].style.marginBottom = String(manjaDimenzijaEkrana * (bootom / 100)) + "px";
        elementsArray[i].style.marginLeft = String(manjaDimenzijaEkrana * (left / 100)) + "px";
        elementsArray[i].style.marginRight = String(manjaDimenzijaEkrana * (right / 100)) + "px";

    }
}

function borderRadiusById(element, radius) {
    document.getElementById(element).style.borderRadius = String(manjaDimenzijaEkrana * (radius / 100)) + "px"
}
...
function borderRadiusByClass(elements, radius) {
    var elementsArray = document.getElementsByClassName(elements);
    for (var i = 0; i < elementsArray.length; i++) {
        elementsArray[i].style.borderRadius = String(manjaDimenzijaEkrana * (radius / 100)) + "px"
    }
}
...
function borderSizeByClaee(elements, size) {
    var elementsArray = document.getElementsByClassName(elements);
    for (var i = 0; i < elementsArray.length; i++) {
        elementsArray[i].style.border = String(manjaDimenzijaEkrana * (size / 100)) + "px solid black"
    }
}

function scalePaddingByClass(elements, top, bootom, left, right) {
    var elementsArray = document.getElementsByClassName(elements);
    for (var i = 0; i < elementsArray.length; i++) {
        elementsArray[i].style.paddingTop = String(manjaDimenzijaEkrana * (top / 100)) + "px";
        elementsArray[i].style.paddingBottom = String(manjaDimenzijaEkrana * (bootom / 100)) + "px";
        elementsArray[i].style.paddingLeft = String(manjaDimenzijaEkrana * (left / 100)) + "px";
        elementsArray[i].style.paddingRight = String(manjaDimenzijaEkrana * (right / 100)) + "px";

    }
}

function scaleBoxShadowByClass(elements, x1, x2, x3, colore) {
    var elementsArray = document.getElementsByClassName(elements);
    for (var i = 0; i < elementsArray.length; i++) {
        elementsArray[i].style.boxShadow = String(manjaDimenzijaEkrana * (x1 / 100)) + "px " + String(manjaDimenzijaEkrana * (x2 / 100)) + "px " + String(manjaDimenzijaEkrana * (x3 / 100)) + "px " + colore;
    }
}
